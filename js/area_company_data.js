...
var kanto = "<div class=\"areaTitle\">関東エリア</div>" +
  ...
  "<dd>日本データスキル株式会社</dd>" +
  "<dd>株式会社ハイマックス</dd>" +
  "<dd>株式会社日立産業制御ソリューションズ</dd>" +
  "<dd>株式会社日立社会情報サービス</dd>" +
  "<dd>株式会社日立情報通信エンジニアリング</dd>" +
  "<dd>フコク情報システム株式会社</dd>" +
  "<dd>株式会社富士通エフサス</dd>" +
...
var kinki = "<div class=\"areaTitle\">近畿エリア</div>" +
  ...
  "<dd>株式会社日新システムズ</dd>" +
  "<dd>日本ソフト開発株式会社</dd>" +
  "<dd>株式会社日本ビジネスデータープロセシングセンター</dd>" +
...
var tokyo = "<div class=\"areaTitle\">東京エリア</div>" +
  ...
  "<dd>株式会社ミライト</dd>" +
  "<dd>株式会社メイテックフィルダーズ</dd>" +
  "<dd>メディア株式会社</dd>" +
  "<dd>株式会社メディアドゥ</dd>" +
  "<dd>株式会社メディア・バスターズ</dd>" +
  "<dd>株式会社mediba</dd>" +
  "<dd>株式会社メルファム</dd>" +
  "<dd>ヤフー株式会社</dd>" +
  "<dd>株式会社ユー・エス・イー</dd>" +
